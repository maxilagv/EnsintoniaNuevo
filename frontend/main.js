          ...
          card.innerHTML = `
            <div class="media-frame relative aspect-[4/3] overflow-hidden rounded-t-2xl">
              ...
              <img src="https://i.postimg.cc/sXRFDbfv/Gemini-Generated-Image-6b363b6b363b6b36.png"
                   alt="Ensintonia"
                   class="pointer-events-none absolute top-2 right-2 w-10 h-10 rounded-full shadow-lg opacity-0 group-hover:opacity-100 group-active:opacity-100 transition-opacity duration-200">
            </div>
